...
const TOOLS = [
    ...
    },
    {
        ...
        description: "Structured web search via Novada (Google, Bing, DuckDuckGo). Returns titles, URLs, and descriptions — no HTML parsing needed. Best for finding pages and factual queries. For reading a specific URL, use agentproxy_fetch instead.",
        inputSchema: {
            type: "object",
            properties: {
