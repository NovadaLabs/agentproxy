...
import { agentproxyFetch, validateFetchParams, agentproxySearch, validateSearchParams, agentproxySession, validateSessionParams, agentproxyStatus, } from "./tools/index.js";
...
const TOOLS = [
    {
        ...
        description: "Fetch any URL through a residential proxy network (2M+ IPs, 195 countries, anti-bot bypass). Use this when you need raw page content from anti-bot sites (Amazon, LinkedIn, Cloudflare-protected pages). Supports geo-targeting and sticky sessions. Requires PROXY_API_KEY.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Structured web search (Google, Bing, DuckDuckGo) via Novada's proxy infrastructure. Returns titles, URLs, and descriptions. Best for: finding pages, factual queries, current events. For reading a specific URL, use agentproxy_fetch instead. Requires NOVADA_API_KEY.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Fetch a URL with a sticky session — guarantees the same residential IP is used every time you pass the same session_id. Use this for multi-step workflows where IP consistency matters (login flows, paginated scraping, price monitoring). Requires PROXY_API_KEY.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Check the proxy network health — returns number of online nodes, device breakdown, and service status. Use this to verify the proxy network is available before starting a scraping workflow.",
        inputSchema: {
            type: "object",
            properties: {},
        },
...
class AgentProxyServer {
    server;
    constructor() {
        this.server = new Server({ name: "agentproxy", version: VERSION }, { capabilities: { tools: {} } });
        this.setupHandlers();
    }
    setupHandlers() {
